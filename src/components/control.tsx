              ...
              <g id="data">
                ...
                <g id="Group 33941">
                  ...
                  <g
                    ...
                    fill={configKey === "WBPRP" ? "#00EEFF" : "#CCCCCC"}>
                    <text
                      id="389 mm"
                      xmlSpace="preserve"
                      style={{ whiteSpace: "nowrap" }}
                  ...
                  <g
                    ...
                    fill={configKey === "W20-1-R" ? "#00EEFF" : "#CCCCCC"}>
                    <text
                      id="432 mm"
                      xmlSpace="preserve"
                      style={{ whiteSpace: "nowrap" }}
                  ...
                  <g
                    ...
                    fill={configKey === "W20-2-R" ? "#00EEFF" : "#CCCCCC"}>
                    <text
                      id="432 mm_2"
                      xmlSpace="preserve"
                      style={{ whiteSpace: "nowrap" }}
              ...
              <g id="data_2">
                ...
                <g id="values">
                  ...
                  <g
                    ...
                    fill={configKey === "H30-1-R" ? "#00EEFF" : "#CCCCCC"}>
                    <text
                      id="291 mm_2"
                  ...
                  <g
                    ...
                    fill={configKey === "L53-1-R" ? "#00EEFF" : "#CCCCCC"}>
                    <text
                      id="810 mm"
                      xmlSpace="preserve"
                      style={{ whiteSpace: "nowrap" }}
                  ...
                  <g
                    ...
                    fill={configKey === "L53-1" ? "#00EEFF" : "#CCCCCC"}>
                    <text
                      id="810 mm_2"
                      xmlSpace="preserve"
                      style={{ whiteSpace: "nowrap" }}
                  ...
                  <g
                    ...
                    fill={configKey === "L63" ? "#00EEFF" : "#CCCCCC"}>
                    <text
                      id="416 mm"
                      xmlSpace="preserve"
                      style={{ whiteSpace: "nowrap" }}
                  ...
                  <g
                    ...
                    fill={configKey === "L50-2-R" ? "#00EEFF" : "#CCCCCC"}>
                    <text
                      id="855 mm_2"
                      xmlSpace="preserve"
                      style={{ whiteSpace: "nowrap" }}
                  ...
                  <g
                    ...
                    fill={configKey === "H30-2-R" ? "#00EEFF" : "#CCCCCC"}>
                    <text
                      id="295 mm_2"
